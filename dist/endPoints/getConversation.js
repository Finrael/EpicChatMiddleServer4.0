...
router.post('/getConversation', (req, res) => __awaiter(this, void 0, void 0, function* () {
    ...
    axios_1.default.post(configFile_1.notificationServer_Api_Adress + '/getConversation', {}, { headers: { cookie: req.headers.cookie, convId: req.body.convId } }).then(function (response) {
